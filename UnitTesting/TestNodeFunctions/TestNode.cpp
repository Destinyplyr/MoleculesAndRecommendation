...
template <typename T>
void TestNode<T>::testNodeCon0(void)
{
...
template <typename T>
void TestNode<T>::testNodeCon2(void)
{
	int i = 5;      				//key
	int g = 7;                      //g
	...
	CPPUNIT_ASSERT(0 == strcmp(mTestObj->getItemName().c_str(), "item568"));
...
template <typename T>
void TestNode<T>::testsetKey(void)
{
	mTestObj->setKey(1);
...
template <typename T>
void TestNode<T>::testsetItemName(void)
{
	mTestObj->setItemName("test");
	CPPUNIT_ASSERT(0 == strcmp(mTestObj->getItemName().c_str(), "test"));
}

template <typename T>
void TestNode<T>::testgetG(void)
{
	mTestObj->setG(1);
	CPPUNIT_ASSERT(1 == mTestObj->getG());
}
...
template <typename T>
void TestNode<T>::testsetCentroid(void)
{
...
CPPUNIT_TEST_SUITE_REGISTRATION( TestNode<int> );
